...
void vita2d_free_texture_(vita2d_texture *texture);
...
void vita2d_create_empty_texture_(vita2d_texture *texture,
                                  unsigned int w, unsigned int h, SceGxmTextureFormat format) {
